...
const Hero = ({ data }) => {
  ...
  return (
    <section id="home" className="home-section bg-dark">
      ...
      <div className="hb-me" style={{ backgroundImage: `url(${ImgLink})`,backgroundSize:"cover",backgroundPosition:"center" }} data-aos="fade-left" data-aos-duration="800" data-aos-delay="800"/>
