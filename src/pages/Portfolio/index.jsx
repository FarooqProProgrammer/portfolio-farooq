    ...
    return (
        <div className='flex-1 bg-[#EAEAEA] h-full flex flex-col gap-5 justify-start items-start overflow-y-auto px-10 py-5'>
            ...
            <Flex justifyContent={'center'} alignItems={'center'} gap={6}>
                <Text cursor={'pointer'} fontSize={'xs'}>All</Text>
                <Text cursor={'pointer'} fontSize={'xs'}>React Js</Text>
                <Text cursor={'pointer'} fontSize={'xs'}>Vue Js</Text>
                <Text cursor={'pointer'} fontSize={'xs'}>HTML</Text>
                <Text cursor={'pointer'} fontSize={'xs'}>Wordpress</Text>
            </Flex>
